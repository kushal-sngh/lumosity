...
oauth2_proxy -client-id="aa4227354123159f6546" -client-secret="877254cf43ef0d9c7a5eadcdb81ed0fd227cf895" -provider="github" -cookie-secret="kushal@##$%-" -email-domain="*" -upstream http://0.0.0.0:80 -redirect-url=http://0.0.0.0:4180/oauth2/callback -cookie-secure=false -http-address=0.0.0.0:4180
