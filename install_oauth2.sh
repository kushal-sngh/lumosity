...
oauth2_proxy -client-id="aa4227354123159f6546" -client-secret="877254cf43ef0d9c7a5eadcdb81ed0fd227cf895" -provider="github" -cookie-secret="kushal" -email-domain="*" -upstream http://172.17.0.2 -redirect-url=http://127.0.0.1:4180/oauth2/callback -cookie-secure=false
